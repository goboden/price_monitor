...
def add_users():
    users = (
        (1, 'Test User 1', 1234567890, 1234567, '1'),
        (2, 'Test User 2', 1234567891, 1234567, '2'),
        (3, 'Test User 3', 1234567892, 1234567, '3'),
        (4, 'Test User 4', 1234567893, 1234567, '4'),
    )
    for user in users:
        add_user(*user)
